...
export default function Hero() {
  ...
  return (
    <section className='relative isolate overflow-hidden bg-linear-to-b from-[#071017] via-[#0A0D12] to-[#070709] text-white'>
      {/* Animated Background */}
      <div className='absolute inset-0 -z-10'>
        ...
        <div className='absolute inset-x-0 bottom-0 h-48 bg-linear-to-t from-[#070709] to-transparent' />
      </div>

      <div
        data-aos='fade-down'
        className='mx-auto max-w-6xl px-4 py-16 sm:py-20 md:py-24 lg:py-32'
      >
        <h1 className='bg-linear-to-r from-[#076ead] to-[#cbe5f5] bg-clip-text text-center text-[34px] font-extrabold leading-[1.1] text-transparent sm:text-5xl md:text-6xl'>
          SBTS GROUP
        </h1>
